...
<div class="content-admin"
    ...
    <div style="
        ...
        padding: 25px;
        border-radius: 12px;
        box-shadow: 0 4px 15px rgba(230, 190, 100, 0.1);
        ...
        <form action="<?= base_url('/admin/artikel/add'); ?>"
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text"
                       ...
                       this.style.boxShadow='0 0 5px rgba(255,217,102,0.3)';
                       "
            ...
            ">
                ...
                <button type="submit"
                        ...
                        transition:0.3s;
                        font-size:14px;
                        box-shadow:0 4px 6px rgba(133,100,4,0.2);
                        "

                        onmouseover="
                        this.style.background='#a17a06';
                        this.style.transform='translateY(-2px)';
                        "

                        onmouseout="
                        this.style.background='#856404';
